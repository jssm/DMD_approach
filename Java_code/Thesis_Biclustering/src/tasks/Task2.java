 ...
 *  
 *  TASK 2 
 *  Data used: ONWebDUALS Lisbon Patients (with Progression group - Slow, Neutral or Fast - as class)
 *  Objective: Experiment to obtain the purest Biclusters in order to discover the most discriminative 
 *  features/sets of features between the 3 progression groups 
 */
...
public class Task2 {
	...
	public static void runQuestion2() throws IOException {
		
		String currentDate = Utils.getCurrentDate();
		TranslationMode translationMode = TranslationMode.Both;
		 
    	String mainFolder = "/Users/joana/Desktop/MCD/Thesis/Data/transformations/OnWebDUALS_LISB_511_300_converted_2019-07-09/Task_2/";
    	String dataset = mainFolder + "ARFF_missings_Patients_PT_OnWebDUALS_LISB_511_300_converted_2019-07-09_controls_selected.arff";		
    	String csvDataset = mainFolder + "CSV_missings_Patients_PT_OnWebDUALS_LISB_511_300_converted_2019-07-09_controls_selected.csv";	
    	String experimentSetFileFolder = "/Users/joana/Desktop/MCD/Thesis/Data/results/Task_2/Task_2_results_" + currentDate;
    	String translationIndexesToCategoryValues = mainFolder + "indexes_to_categories_Patients_PT_OnWebDUALS_LISB_511_300_converted_2019-07-09_controls_selected.tsv";
    	String translationCategoryValuesToLabels = mainFolder + "categories_labels_Patients_PT_OnWebDUALS_LISB_511_300_converted_2019-07-09_controls_selected.xlsx";
		...
		Double[] stoppingCriteriaValue = {0.4D, 0.35D, 0.3D, 0.25D, 0.2D, 
										  0.15D, 0.1D, 0.05D, 0.025D, 0.01D};	
