...
dataset_file_name = "CSV_baseline_ALL_OnWebDUALS_LISB_511_300_converted_2019-07-09_controls_selected.csv"
# name of the labels xlsx
xslx_translation_categories_labels = "categories_labels_ALL_OnWebDUALS_LISB_511_300_converted_2019-07-09_controls_selected.xlsx"
# Output folder for results 
output_folder = Path("/Users/joana/Desktop/MCD/Thesis/Data/results/Task_1/Task_1_results_" + folder_date + "/association_rules_baseline/")
...
to_keep_task_1 = ['Age (on date of consultation)','Gender','Place of birth',\
                  'Mothers Place of birth characteristics','Blood hypertension',\
                  'Hypercholesterolemia','Primary cancer','Psychiatric medication',\
                  'NSAID','Was there ALS in the family','Other severe disease 1 of mother',\
                  'Mother alive','Mothers cause of death','Fathers cause of death',\
                  'Regular physical exercise','Thoracic Spine surgery in the last 5 years',\
                  'Main Occupation in the last 5 years (level 1)',\
                  'Main Occupation > 5 years (level 1)','Place of living in the last 5 years',\
                  'Lives in Rural Area or Urban > 5 years', 'group']
