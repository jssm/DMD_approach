...
classif_file_name = "Exp_9_CSV_classifier_" + folder_date + ".csv"
# Output folder for results
output_folder = Path("/Users/joana/Desktop/MCD/Thesis/Data/results/Task_2/Task_2_results_" + folder_date + "/classification_matrix_subjects_bics/")
